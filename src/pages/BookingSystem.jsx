...
const CONFIG = {
  ...
  services: {
    "rec-voice": { name: "Registrazione Voce", pricePerHour: 50, icon: "🎤", color: "#8B5CF6" },
    "rec-instruments": { name: "Registrazione Strumenti", pricePerHour: 60, icon: "🎸", color: "#EC4899" },
    "mix-master": { name: "Mix & Master", pricePerHour: 80, icon: "🎛️", color: "#10B981" },
    "beat-prod": { name: "Produzione Beat", pricePerHour: 70, icon: "🎹", color: "#F59E0B" },
    "editing": { name: "Editing Audio", pricePerHour: 45, icon: "✂️", color: "#3B82F6" },
    "vocal-tuning": { name: "Vocal Tuning", pricePerHour: 40, icon: "🎵", color: "#EC4899" }
  },
  rooms: [
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '15px' }}>
            <div>
              <h1 style={{ margin: '0 0 5px 0', fontSize: '2rem', fontWeight: 700 }}>
                {CONFIG.brand.logo} Booking System
              </h1>
