...
import { CASSA_CONFIG, getProdottiByCategoria, formatPrezzo, generateNumeroVendita } from '../config/cassa.config';
...
const Cassa = () => {
  ...
  useEffect(() => {
    ...
    if (savedSales) setVendite(JSON.parse(savedSales));

    const savedClients = localStorage.getItem('studio_artists');
    if (savedClients) setClienti(JSON.parse(savedClients));
  }, []);
  ...
  const prodottiFiltrati = () => {
    let prodotti = getProdottiByCategoria(categoriaSelezionata);
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
            <button onClick={() => navigate('/')} className="btn-secondary" style={{ background: 'rgba(255,255,255,0.2)', color: 'white', border: 'none' }}>
              ← Indietro
            </button>
            <div>
              <h1 style={{ margin: 0, fontSize: '2rem', fontWeight: 700 }}>💰 Cassa Studio</h1>
              <p style={{ margin: '5px 0 0 0', opacity: 0.9 }}>Vendite accessori e prodotti</p>
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            ...
            <button
              ...
              style={{
                ...
                color: view === 'storico' ? '#667eea' : 'white',
                border: 'none'
              }}
            >
              📋 Storico
            ...
            <button
              ...
              style={{
                ...
                color: view === 'analytics' ? '#667eea' : 'white',
                border: 'none'
              }}
            >
              📊 Statistiche
            ...
            <div>
              ...
              <div style={{ background: 'white', padding: '20px', borderRadius: '12px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                  {CASSA_CONFIG.productCategories.map(cat => (
                    <button
                      key={cat.id}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: '15px' }}>
                {prodottiFiltrati().map(prodotto => (
                  ...
                  >
                    <div style={{ fontSize: '2.5rem', marginBottom: '10px' }}>{prodotto.icon}</div>
                    ...
                    carrello.map(item => (
                      <div key={item.id} className="cart-item">
                        ...
                        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                          ...
                          <div style={{ marginLeft: 'auto', fontWeight: 700, color: '#8B5CF6' }}>
                ...
                {carrello.length > 0 && (
                  <>
                    <div style={{ borderTop: '2px solid #E5E7EB', paddingTop: '15px', marginBottom: '15px' }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '1.3rem', fontWeight: 700, color: '#8B5CF6' }}>
                        <span>TOTALE:</span>
                  ...
                  <tbody>
                    {vendite.map(vendita => (
                      <tr key={vendita.id} style={{ borderBottom: '1px solid #E5E7EB' }}>
                        ...
                        <td style={{ padding: '12px', textAlign: 'right', fontWeight: 700, color: '#8B5CF6' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '30px' }}>
              <div style={{ background: 'white', borderRadius: '12px', padding: '25px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                ...
                <div style={{ fontSize: '2.5rem', fontWeight: 700, color: '#8B5CF6' }}>{stats.venditeOggi}</div>
              </div>
              <div style={{ background: 'white', borderRadius: '12px', padding: '25px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
              ...
              <div style={{ background: 'white', borderRadius: '12px', padding: '25px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
                ...
                <div style={{ fontSize: '2.5rem', fontWeight: 700, color: '#8B5CF6' }}>{stats.totalVendite}</div>
              </div>
              <div style={{ background: 'white', borderRadius: '12px', padding: '25px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)' }}>
